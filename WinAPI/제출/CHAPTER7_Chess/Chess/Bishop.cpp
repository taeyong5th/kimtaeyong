...
std::list<std::pair<BOARD_POSITION_X, BOARD_POSITION_Y>> Bishop::getMovablePositions(Board* board)
{
...
std::list<std::pair<BOARD_POSITION_X, BOARD_POSITION_Y>> Bishop::getAttackablePositions(Board* board)
{
...
Bishop::Bishop(LPCWSTR bitmapName, BOARD_POSITION_X x, BOARD_POSITION_Y y, TEAM team) :
